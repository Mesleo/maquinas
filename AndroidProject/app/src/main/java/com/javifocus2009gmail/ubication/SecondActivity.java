...
public class SecondActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private static final String URL_ROOT = "RAIZ_URL";
    private static final String URL_GET_MACHINES = URL_ROOT + "/getMachines.php";
    private static final String URL_SET_UBICATION = URL_ROOT + "/setUbication.php";
    private static final String URL_GET_UBICATIONS_MACHINE = URL_ROOT + "/getUbications.php";
    private static final String URL_NOTIFICATION = URL_ROOT + "/sendNotifications.php";// Previsto añadir sistema de notificaciones
...
//                    idMachine = object.substring(object.indexOf("id="), object.indexOf(",")).replace("id=", "");
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()) {
            case R.id.btnSave:
                ...
                if (ubicationMachine.length() > 2) {
                    showAlertDialog("¿Seguro que quiere añadir esta ubicación a la máquina " + nameMachine + " ?", true);
                } else {
                    showAlertDialog("Debe escribir al menos 3 caracteres.", false);
                }
                break;
            default:
                break;
    ...
    private void showAlertDialog(final String message, final boolean b) {
            ...
            dialog.setNegativeButton("Cancelar", new DialogInterface.OnClickListener() {
                public void onClick(DialogInterface dialog, int id) {
                    Toast.makeText(SecondActivity.this,
                            "No se ha modificado la ubicación de la máquina", Toast.LENGTH_LONG);
                }
            });
        }
        dialog.show();
...
//                        machine.put("matricula", enrolment);
        ...
        protected void onPostExecute(Void result) {
            ...
            adapterMachines = new SimpleAdapter(
                    ...
                    new int[]{R.id.nameMachine, R.id.enrolmentMachine});
