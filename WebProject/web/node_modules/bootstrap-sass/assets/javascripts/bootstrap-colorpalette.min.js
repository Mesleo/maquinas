    ...
    var createPaletteElement = function(element, _aaColor) {
        ...
        $.each(_aaColor, function(i, aColor){
            ...
            $.each(aColor, function(i, sColor) {
                ...
                if($.isArray(sColor[0])){
                    sColor = "linear-gradient(-61deg, "+sColor[0][0]+" 0%, "+sColor[0][0] +" 50%, "+sColor[0][1]+" 50%, "+sColor[0][1]+" 50%) ";
                }
                var sButton = ['<button type="button" class="btn-color" style="background:', sColor[0],
                    '" data-value="', sColor[1],
                    '" title="', sColor[1],
                    '"></button>'].join('');
                aHTML.push(sButton);
